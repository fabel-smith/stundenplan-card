...
const ie = (e) => new zt(typeof e == "string" ? e : e + "", void 0, wt), Ft = (e, ...t) => {
  ...
  return ie(i);
})(e) : e, { is: re, defineProperty: ne, getOwnPropertyDescriptor: oe, getOwnPropertyNames: ae, getOwnPropertySymbols: le, getPrototypeOf: he } = Object, ht = globalThis, Mt = ht.trustedTypes, ce = Mt ? Mt.emptyScript : "", ue = ht.reactiveElementPolyfillSupport, B = (e, t) => e, ot = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? ce : null;
      break;
  ...
  return i;
} }, bt = (e, t) => !re(e, t), Dt = { attribute: !0, type: String, converter: ot, reflect: !1, useDefault: !1, hasChanged: bt };
...
O.elementStyles = [], O.shadowRootOptions = { mode: "open" }, O[B("elementProperties")] = /* @__PURE__ */ new Map(), O[B("finalized")] = /* @__PURE__ */ new Map(), ue?.({ ReactiveElement: O }), (ht.reactiveElementVersions ??= []).push("2.1.2");
const $t = globalThis, jt = (e) => e, at = $t.trustedTypes, Tt = at ? at.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Bt = "$lit$", E = `lit$${Math.random().toFixed(9).slice(2)}$`, It = "?" + E, de = `<${It}>`, j = document, I = () => j.createComment(""), J = (e) => e === null || typeof e != "object" && typeof e != "function", vt = Array.isArray, _e = (e) => vt(e) || typeof e?.[Symbol.iterator] == "function", _t = `[ 	
\f\r]`, z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Rt = /-->/g, Ot = />/g, M = RegExp(`>|${_t}(?:([^\\s"'>=/]+)(${_t}*=${_t}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Wt = /'/g, Ut = /"/g, Jt = /^(?:script|style|textarea|title)$/i, ge = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), c = ge(1), U = /* @__PURE__ */ Symbol.for("lit-noChange"), p = /* @__PURE__ */ Symbol.for("lit-nothing"), Nt = /* @__PURE__ */ new WeakMap(), D = j.createTreeWalker(j, 129);
function Vt(e, t) {
...
const pe = (e, t) => {
  ...
  for (let l = 0; l < i; l++) {
    const a = e[l];
    let d, u, _ = -1, h = 0;
    for (; h < a.length && (o.lastIndex = h, u = o.exec(a), u !== null); ) h = o.lastIndex, o === z ? u[1] === "!--" ? o = Rt : u[1] !== void 0 ? o = Ot : u[2] !== void 0 ? (Jt.test(u[2]) && (r = RegExp("</" + u[2], "g")), o = M) : u[3] !== void 0 && (o = M) : o === M ? u[0] === ">" ? (o = r ?? z, _ = -1) : u[1] === void 0 ? _ = -2 : (_ = o.lastIndex - u[2].length, d = u[1], o = u[3] === void 0 ? M : u[3] === '"' ? Ut : Wt) : o === Ut || o === Wt ? o = M : o === Rt || o === Ot ? o = z : (o = M, r = void 0);
    const g = o === M && e[l + 1].startsWith("/>") ? " " : "";
    n += o === z ? a + de : _ >= 0 ? (s.push(d), a.slice(0, _) + Bt + a.slice(_) + E + g) : a + E + (_ === -2 ? l : g);
  }
...
class V {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const l = t.length - 1, a = this.parts, [d, u] = pe(t, i);
    if (this.el = V.createElement(d, s), D.currentNode = this.el.content, i === 2 || i === 3) {
      const _ = this.el.content.firstChild;
      _.replaceWith(..._.childNodes);
    }
    for (; (r = D.nextNode()) !== null && a.length < l; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const _ of r.getAttributeNames()) if (_.endsWith(Bt)) {
          const h = u[o++], g = r.getAttribute(_).split(E), y = /([.?@])?(.*)/.exec(h);
          a.push({ type: 1, index: n, name: y[2], strings: g, ctor: y[1] === "." ? me : y[1] === "?" ? ye : y[1] === "@" ? we : ct }), r.removeAttribute(_);
        ...
        if (Jt.test(r.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let g = 0; g < h; g++) r.append(_[g], I()), D.nextNode(), a.push({ type: 2, index: ++n });
            r.append(_[h], I());
          }
        }
...
class fe {
  ...
  u(t) {
    ...
    D.currentNode = r;
    let n = D.nextNode(), o = 0, l = 0, a = s[0];
    for (; a !== void 0; ) {
      if (o === a.index) {
        let d;
        a.type === 2 ? d = new Y(n, n.nextSibling, this, t) : a.type === 1 ? d = new a.ctor(n, a.name, a.strings, this, t) : a.type === 6 && (d = new be(n, this, t)), this._$AV.push(d), a = s[++l];
      }
...
class Y {
  ...
  _$AI(t, i = this) {
    t = N(this, t, i), J(t) ? t === p || t == null || t === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : t !== this._$AH && t !== U && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : _e(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== p && J(this._$AH) ? this._$AA.nextSibling.data = t : this.T(j.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: i, _$litType$: s } = t, r = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = V.createElement(Vt(s.h, s.h[0]), this.options)), s);
  ...
  _$AC(t) {
    ...
    return i === void 0 && Nt.set(t.strings, i = new V(t)), i;
  }
  k(t) {
    vt(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let s, r = 0;
    for (const n of t) r === i.length ? i.push(s = new Y(this.O(I()), this.O(I()), this, this.options)) : s = i[r], s._$AI(n), r++;
...
class ct {
  ...
  _$AI(t, i = this, s, r) {
    ...
    let o = !1;
    if (n === void 0) t = N(this, t, i, 0), o = !J(t) || t !== this._$AH && t !== U, o && (this._$AH = t);
    else {
      const l = t;
      let a, d;
      for (t = n[0], a = 0; a < n.length - 1; a++) d = N(this, l[s + a], i, a), d === U && (d = this._$AH[a]), o ||= !J(d) || d !== this._$AH[a], d === p ? t = p : t !== p && (t += (d ?? "") + n[a + 1]), this._$AH[a] = d;
    }
    o && !r && this.j(t);
  }
  j(t) {
...
$e?.(V, Y), ($t.litHtmlVersions ??= []).push("3.3.2");
const ve = (e, t, i) => {
  const s = i?.renderBefore ?? t;
  let r = s._$litPart$;
  if (r === void 0) {
    const n = i?.renderBefore ?? null;
    s._$litPart$ = r = new Y(t.insertBefore(I(), n), n, void 0, i ?? {});
  }
  return r._$AI(e), r;
}, xt = globalThis;
class W extends O {
...
const ke = { attribute: !0, type: String, converter: ot, reflect: !1, hasChanged: bt }, Se = (e = ke, t, i) => {
...
function Yt(e) {
  return (t, i) => typeof i == "object" ? Se(e, t, i) : ((s, r, n) => {
...
var Ae = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, qt = (e) => {
  throw TypeError(e);
}, b = (e, t, i, s) => {
  for (var r = s > 1 ? void 0 : s ? Ee(t, i) : t, n = e.length - 1, o; n >= 0; n--)
    (o = e[n]) && (r = (s ? o(t, i, r) : o(r)) || r);
  return s && r && Ae(t, i, r), r;
}, Kt = (e, t, i) => t.has(e) || qt("Cannot " + i), x = (e, t, i) => (Kt(e, t, "read from private field"), i ? i.call(e) : t.get(e)), k = (e, t, i) => t.has(e) ? qt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), S = (e, t, i, s) => (Kt(e, t, "write to private field"), t.set(e, i), i), Q, X, tt, et, it, st, rt, nt;
function lt(e) {
  return !!e && e.break === !0;
}
function kt(e) {
...
function Ce(e) {
  ...
  const t = {};
  return typeof e.bg == "string" && e.bg.trim() && (t.bg = e.bg.trim()), typeof e.color == "string" && e.color.trim() && (t.color = e.color.trim()), typeof e.border == "string" && e.border.trim() && (t.border = e.border.trim()), typeof e.bg_alpha == "number" && !Number.isNaN(e.bg_alpha) && (t.bg_alpha = kt(e.bg_alpha)), Object.keys(t).length ? t : null;
}
function Me(e) {
  if (!e?.bg) return null;
  const t = e.bg.trim();
  ...
  const i = Zt(t);
  if (!i) return t;
  const s = typeof e.bg_alpha == "number" ? kt(e.bg_alpha) : 0.18;
...
function Pt(e, t) {
  ...
  if (i.startsWith("#")) {
    const s = Zt(i);
    return s ? `rgba(${s.r}, ${s.g}, ${s.b}, ${kt(t)})` : i;
  }
  return i;
}
function gt(e) {
...
const $ = (F = class extends W {
  constructor() {
    super(...arguments), k(this, Q), k(this, X), k(this, tt, []), k(this, et, !1), k(this, it, ""), k(this, st, null), k(this, rt, "idle"), k(this, nt, ""), this._jsonUrlLast = "", this._lastWatchSig = null, this._lastWeekOffset = null;
  }
  getGridOptions() {
    return { columns: "full" };
  }
  ...
  async setWeekOffset(e, t) {
    ...
    let a = Number(t);
    Number.isFinite(a) || (a = 0), a = Math.max(o, Math.min(l, a));
    const d = i.split(".")[0];
    try {
      await this.hass.callService(d, "set_value", { entity_id: i, value: a });
      const u = [
        i,
        (e.source_entity ?? "").trim(),
        (e.source_entity_a ?? "").trim(),
        (e.source_entity_b ?? "").trim(),
        (e.week_map_entity ?? "").trim()
      ].filter((_) => !!_);
      u.length && await this.hass.callService("homeassistant", "update_entity", { entity_id: u });
    } catch (u) {
      console.error("stundenplan-card: setWeekOffset failed", u);
    }
    this.requestUpdate();
  }
  connectedCallback() {
  ...
  normalizeConfig(e) {
    const t = F.getStubConfig(), i = Array.isArray(e.days) && e.days.length ? e.days.map((a) => (a ?? "").toString()) : ["Mo", "Di", "Mi", "Do", "Fr"], s = (Array.isArray(e.rows) ? e.rows : []).map((a) => {
      if (lt(a))
        return { break: !0, time: (a.time ?? "").toString(), label: (a.label ?? "Pause").toString() };
      const d = Array.isArray(a?.cells) ? a.cells : [], u = Array.from({ length: i.length }, (v, w) => (d[w] ?? "").toString()), _ = Array.isArray(a?.cell_styles) ? a.cell_styles : [], h = Array.from({ length: i.length }, (v, w) => Ce(_[w])), g = (a?.time ?? "").toString(), y = gt(g), q = (a?.start ?? "").toString().trim(), m = (a?.end ?? "").toString().trim(), f = {
        time: g,
        start: q || y.start || void 0,
        end: m || y.end || void 0,
        cells: u
      };
      return h.some((v) => !!v) && (f.cell_styles = h), f;
    }), r = ((e.week_mode ?? t.week_mode) + "").toString().trim(), n = r === "kw_parity" || r === "week_map" || r === "off" ? r : "off", o = (e.source_entity ?? t.source_entity).toString().trim(), l = (e.week_offset_entity ?? "").toString().trim() || Te(o);
    return {
      ...
      source_entity: o,
      source_attribute: (e.source_attribute ?? t.source_attribute).toString(),
      source_time_key: (e.source_time_key ?? t.source_time_key).toString(),
      source_type: ((e.source_type ?? (o ? "entity" : "manual")) + "").toString().trim(),
  ...
  buildRowsFromArray(e, t) {
    ...
    const i = e.days ?? [], s = (e.source_time_key ?? "time").toString(), r = t.map((n) => {
      ...
      const o = (n?.time ?? n?.[s] ?? "").toString(), l = gt(o), a = Array.from({ length: i.length }, (_, h) => {
        ...
        return (n?.[g] ?? "").toString();
      }), d = (n?.start ?? "").toString().trim() || l.start, u = (n?.end ?? "").toString().trim() || l.end;
      return { time: o, start: d || void 0, end: u || void 0, cells: a };
    });
  ...
  getHeaderDaysFromEntity(e) {
    ...
    for (const n of s) {
      ...
      if (!o) continue;
      const l = Number(o[1]), a = Number(o[2]), d = Number(o[3]), u = new Date(l, a - 1, d, 12, 0, 0, 0);
...
`).map((h) => h.trim()).filter((h) => h.length > 0);
    ...
    return { fach: r, raum: d, lehrer: u, notes: _.length ? _ : void 0 };
  }
  renderCell(e, t) {
      ...
      return c`
        <div class="cellWrap">
          ...
          ${r.notes?.length ? c`
                <div class="notes">
                  ${r.notes.map((a) => {
        const d = a.startsWith("🔴") ? "note noteRed" : a.startsWith("🟠") ? "note noteOrange" : a.startsWith("🟡") ? "note noteYellow" : "note", u = a.replace(/^[🟠🔴🟡🟢⚪️🟣🟤]\s*/g, "").trim();
        return c`<div class=${d}><span class="dot">${a.slice(0, 2).trim()}</span><span class="txt">${u}</span></div>`;
      })}
                </div>
              ` : c``}
        </div>
...
`).map((a) => a.trim()).filter(Boolean), o = (n[0] ?? "").trim(), l = n.slice(1);
    return o && l.length ? c`
        <div class="cellWrap">
          ...
          <div class="notes">
            ${l.map((a) => {
      const d = a.startsWith("🔴") ? "note noteRed" : a.startsWith("🟠") ? "note noteOrange" : a.startsWith("🟡") ? "note noteYellow" : "note", u = a.replace(/^[🟠🔴🟡🟢⚪️🟣🟤]\s*/g, "").trim(), _ = /^[🟠🔴🟡🟢⚪️🟣🟤]/.test(a) ? a.slice(0, 2).trim() : "•";
      return c`<div class=${d}><span class="dot">${_}</span><span class="txt">${u || a}</span></div>`;
    })}
          </div>
        </div>
    ...
    return c`
      <ha-card>
        <div class="headerRow">
          ...
          <div class="headRight">
            ${a ? c`<div class="weekBadgeInline">Woche <b>${d}</b></div>` : c``}
          ...
          <table>
            <thead>
              <tr>
                ...
                ${e.days.map((m, f) => {
      const v = e.highlight_today && f === i ? "today" : "";
      let w = "";
      if (g)
        w = this.fmtDDMMYYYY(g[f]);
      else {
        const T = Re(m);
        if (T) {
          const K = new Date(q);
          K.setDate(q.getDate() + (T - 1)), w = this.fmtDDMMYYYY(K);
        }
      }
      return c`
                    <th class=${v} style=${`--sp-hl:${r};`}>
                      <div>${m}</div>
                      <div class="thDate">${w}</div>
                    </th>
                  `;
    })}
              </tr>
            ...
            <tbody>
              ${this._noData ? c`<tr class="nodata"><td class="nodataCell" colspan=${(e.days?.length ?? 0) + 1}>${this._noDataMsg}</td></tr>` : t.map((m) => {
      if (lt(m)) {
        const P = gt(m.time), R = !!P.start && !!P.end && this.isNowBetween(P.start, P.end), H = !!e.highlight_breaks && R;
        let L = `--sp-hl:${n};`, Z = "";
        return H && (L += "box-shadow: inset 0 0 0 9999px var(--sp-hl);", Z += `--sp-hl:${n}; box-shadow: inset 0 0 0 9999px var(--sp-hl);`), H && e.highlight_current_time_text && l && (L += `color:${l};`), c`
                    <tr class="break">
                      <td class="time" style=${L}>${m.time}</td>
                      <td colspan=${e.days.length} style=${Z}>${m.label ?? ""}</td>
                    </tr>
                  `;
      }
      const f = m, v = f.cells ?? [], w = f.cell_styles ?? [], T = !!f.start && !!f.end && this.isNowBetween(f.start, f.end), K = i >= 0 ? v[i] ?? "" : "", Xt = i >= 0 ? this.filterCellText(K, e) : "", te = i >= 0 ? pt(Xt) : !1, ut = !(e.free_only_column_highlight && te), St = f.start && f.end ? `${f.start}–${f.end}` : "";
      let dt = `--sp-hl:${n};`;
      return ut && e.highlight_current && T && (dt += "box-shadow: inset 0 0 0 9999px var(--sp-hl);"), ut && T && e.highlight_current_time_text && l && (dt += `color:${l};`), c`
                  <tr>
                    <td class="time" style=${dt}>
                      <div class="timeWrap">
                        <div class="timeSt">${f.time}</div>
                        ${St ? c`<div class="timeHm">${St}</div>` : c``}
                      </div>
                    </td>

                    ${e.days.map((P, R) => {
        const H = this.filterCellText(v[R] ?? "", e), L = w[R] ?? null, Z = e.highlight_today && R === i ? "today" : "";
        let At = `--sp-hl:${r};` + De(L, s);
        const ee = !pt(H);
        return ut && ee && T && e.highlight_current_text && o && i >= 0 && R === i && (At += `color:${o};`), c`<td class=${Z} style=${At}>${this.renderCell(H, e)}</td>`;
      })}
                  </tr>
                `;
    })}
...
const mt = class extends W {
  ...
  setSourceType(t) {
    ...
    const i = t === "entity" || t === "json" || t === "manual" ? t : "manual", s = { ...this._config, source_type: i };
    i === "json" && s.json_url == null && (s.json_url = ""), i === "entity" && (s.source_entity == null && (s.source_entity = ""), s.source_attribute = "rows_table", s.source_time_key = "time"), this.emit(s);
  }
  setSourceEntity(t) {
    if (!this._config) return;
    const i = (t ?? "").toString().trim();
          ...
          console.error("stundenplan-card editor: ha-form value-changed failed", s);
            ...
            ${(t.source_type ?? "manual") === "entity" ? c`
                  ${this.isHaEntityPickerAvailable() ? c`
                        ${(() => {
        const i = Object.keys(this.hass?.states ?? {}).filter((r) => /^sensor\./.test(r) && /_woche$/i.test(r)), s = Object.keys(this.hass?.states ?? {}).length;
        return s < 20 || s > 0 && i.length === 0 ? c`<div class="hint">Lade Stundenplan-Sensoren…</div>` : c``;
      })()}
                        <ha-entity-picker
                          .hass=${this.hass}
