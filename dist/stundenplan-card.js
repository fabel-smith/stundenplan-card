const G = globalThis, yt = G.ShadowRoot && (G.ShadyCSS === void 0 || G.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, wt = /* @__PURE__ */ Symbol(), Et = /* @__PURE__ */ new WeakMap();
let zt = class {
  constructor(e, t, i) {
...
const ie = (e) => new zt(typeof e == "string" ? e : e + "", void 0, wt), Bt = (e, ...t) => {
  ...
  return ie(i);
})(e) : e, { is: re, defineProperty: ne, getOwnPropertyDescriptor: oe, getOwnPropertyNames: ae, getOwnPropertySymbols: le, getPrototypeOf: ce } = Object, ct = globalThis, Mt = ct.trustedTypes, he = Mt ? Mt.emptyScript : "", ue = ct.reactiveElementPolyfillSupport, I = (e, t) => e, ot = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? he : null;
      break;
  ...
  return i;
} }, bt = (e, t) => !re(e, t), Tt = { attribute: !0, type: String, converter: ot, reflect: !1, useDefault: !1, hasChanged: bt };
...
let O = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(I("properties"))) {
      const t = this.properties, i = [...ae(t), ...le(t)];
  ...
  _$ET(e, t) {
    ...
    if (s !== void 0 && i.reflect === !0) {
      const r = (i.converter?.toAttribute !== void 0 ? i.converter : ot).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const r = i.getPropertyOptions(s), n = typeof r.converter == "function" ? { fromAttribute: r.converter } : r.converter?.fromAttribute !== void 0 ? r.converter : ot;
      this._$Em = s;
  ...
  requestUpdate(e, t, i, s = !1, r) {
    if (e !== void 0) {
      ...
      if (s === !1 && (r = this[e]), i ??= n.getPropertyOptions(e), !((i.hasChanged ?? bt)(r, t) || i.useDefault && i.reflect && r === this._$Ej?.get(e) && !this.hasAttribute(n._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
O.elementStyles = [], O.shadowRootOptions = { mode: "open" }, O[I("elementProperties")] = /* @__PURE__ */ new Map(), O[I("finalized")] = /* @__PURE__ */ new Map(), ue?.({ ReactiveElement: O }), (ct.reactiveElementVersions ??= []).push("2.1.2");
const $t = globalThis, jt = (e) => e, at = $t.trustedTypes, Dt = at ? at.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Ft = "$lit$", E = `lit$${Math.random().toFixed(9).slice(2)}$`, It = "?" + E, de = `<${It}>`, D = document, J = () => D.createComment(""), V = (e) => e === null || typeof e != "object" && typeof e != "function", vt = Array.isArray, ge = (e) => vt(e) || typeof e?.[Symbol.iterator] == "function", gt = `[ 	
\f\r]`, B = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Rt = /-->/g, Ot = />/g, T = RegExp(`>|${gt}(?:([^\\s"'>=/]+)(${gt}*=${gt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Wt = /'/g, Ut = /"/g, Jt = /^(?:script|style|textarea|title)$/i, _e = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), u = _e(1), U = /* @__PURE__ */ Symbol.for("lit-noChange"), p = /* @__PURE__ */ Symbol.for("lit-nothing"), Nt = /* @__PURE__ */ new WeakMap(), j = D.createTreeWalker(D, 129);
function Vt(e, t) {
...
const pe = (e, t) => {
  ...
  for (let l = 0; l < i; l++) {
    const a = e[l];
    let c, d, g = -1, h = 0;
    for (; h < a.length && (o.lastIndex = h, d = o.exec(a), d !== null); ) h = o.lastIndex, o === B ? d[1] === "!--" ? o = Rt : d[1] !== void 0 ? o = Ot : d[2] !== void 0 ? (Jt.test(d[2]) && (r = RegExp("</" + d[2], "g")), o = T) : d[3] !== void 0 && (o = T) : o === T ? d[0] === ">" ? (o = r ?? B, g = -1) : d[1] === void 0 ? g = -2 : (g = o.lastIndex - d[2].length, c = d[1], o = d[3] === void 0 ? T : d[3] === '"' ? Ut : Wt) : o === Ut || o === Wt ? o = T : o === Rt || o === Ot ? o = B : (o = T, r = void 0);
    const _ = o === T && e[l + 1].startsWith("/>") ? " " : "";
    n += o === B ? a + de : g >= 0 ? (s.push(c), a.slice(0, g) + Ft + a.slice(g) + E + _) : a + E + (g === -2 ? l : _);
  }
...
class Y {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const l = t.length - 1, a = this.parts, [c, d] = pe(t, i);
    if (this.el = Y.createElement(c, s), j.currentNode = this.el.content, i === 2 || i === 3) {
      const g = this.el.content.firstChild;
      g.replaceWith(...g.childNodes);
    }
    for (; (r = j.nextNode()) !== null && a.length < l; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const g of r.getAttributeNames()) if (g.endsWith(Ft)) {
          const h = d[o++], _ = r.getAttribute(g).split(E), w = /([.?@])?(.*)/.exec(h);
          a.push({ type: 1, index: n, name: w[2], strings: _, ctor: w[1] === "." ? me : w[1] === "?" ? ye : w[1] === "@" ? we : ht }), r.removeAttribute(g);
        } else g.startsWith(E) && (a.push({ type: 6, index: n }), r.removeAttribute(g));
        if (Jt.test(r.tagName)) {
          const g = r.textContent.split(E), h = g.length - 1;
          if (h > 0) {
            r.textContent = at ? at.emptyScript : "";
            for (let _ = 0; _ < h; _++) r.append(g[_], J()), j.nextNode(), a.push({ type: 2, index: ++n });
            r.append(g[h], J());
          }
        }
        ...
        let g = -1;
        for (; (g = r.data.indexOf(E, g + 1)) !== -1; ) a.push({ type: 7, index: n }), g += E.length - 1;
      }
      n++;
    }
  }
...
function N(e, t, i = e, s) {
  ...
  return r?.constructor !== n && (r?._$AO?.(!1), n === void 0 ? r = void 0 : (r = new n(e), r._$AT(e, i, s)), s !== void 0 ? (i._$Co ??= [])[s] = r : i._$Cl = r), r !== void 0 && (t = N(e, r._$AS(e, t.values), r, s)), t;
}
class fe {
  constructor(t, i) {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (o === a.index) {
        let c;
        a.type === 2 ? c = new K(n, n.nextSibling, this, t) : a.type === 1 ? c = new a.ctor(n, a.name, a.strings, this, t) : a.type === 6 && (c = new be(n, this, t)), this._$AV.push(c), a = s[++l];
      }
...
class K {
  ...
  _$AI(t, i = this) {
    t = N(this, t, i), V(t) ? t === p || t == null || t === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : t !== this._$AH && t !== U && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ge(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== p && V(this._$AH) ? this._$AA.nextSibling.data = t : this.T(D.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: i, _$litType$: s } = t, r = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = Y.createElement(Vt(s.h, s.h[0]), this.options)), s);
  ...
  _$AC(t) {
    ...
    return i === void 0 && Nt.set(t.strings, i = new Y(t)), i;
  }
  k(t) {
...
class ht {
  ...
  _$AI(t, i = this, s, r) {
    ...
    let o = !1;
    if (n === void 0) t = N(this, t, i, 0), o = !V(t) || t !== this._$AH && t !== U, o && (this._$AH = t);
    else {
      const l = t;
      let a, c;
      for (t = n[0], a = 0; a < n.length - 1; a++) c = N(this, l[s + a], i, a), c === U && (c = this._$AH[a]), o ||= !V(c) || c !== this._$AH[a], c === p ? t = p : t !== p && (t += (c ?? "") + n[a + 1]), this._$AH[a] = c;
    }
    o && !r && this.j(t);
  }
  j(t) {
...
const $e = $t.litHtmlPolyfillSupport;
$e?.(Y, K), ($t.litHtmlVersions ??= []).push("3.3.2");
const ve = (e, t, i) => {
...
W._$litElement$ = !0, W.finalized = !0, xt.litElementHydrateSupport?.({ LitElement: W });
const xe = xt.litElementPolyfillSupport;
xe?.({ LitElement: W });
(xt.litElementVersions ??= []).push("4.2.2");
const Se = { attribute: !0, type: String, converter: ot, reflect: !1, hasChanged: bt }, ke = (e = Se, t, i) => {
...
var Ae = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, Kt = (e) => {
  throw TypeError(e);
}, $ = (e, t, i, s) => {
  for (var r = s > 1 ? void 0 : s ? Ee(t, i) : t, n = e.length - 1, o; n >= 0; n--)
    (o = e[n]) && (r = (s ? o(t, i, r) : o(r)) || r);
  return s && r && Ae(t, i, r), r;
}, Zt = (e, t, i) => t.has(e) || Kt("Cannot " + i), x = (e, t, i) => (Zt(e, t, "read from private field"), i ? i.call(e) : t.get(e)), S = (e, t, i) => t.has(e) ? Kt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), k = (e, t, i, s) => (Zt(e, t, "write to private field"), t.set(e, i), i), Q, X, tt, et, it, st, rt, nt;
function lt(e) {
  return !!e && e.break === !0;
}
function St(e) {
...
function Ce(e) {
  ...
  const t = {};
  return typeof e.bg == "string" && e.bg.trim() && (t.bg = e.bg.trim()), typeof e.color == "string" && e.color.trim() && (t.color = e.color.trim()), typeof e.border == "string" && e.border.trim() && (t.border = e.border.trim()), typeof e.bg_alpha == "number" && !Number.isNaN(e.bg_alpha) && (t.bg_alpha = St(e.bg_alpha)), Object.keys(t).length ? t : null;
}
function Me(e) {
  if (!e?.bg) return null;
  const t = e.bg.trim();
  ...
  const i = qt(t);
  if (!i) return t;
  const s = typeof e.bg_alpha == "number" ? St(e.bg_alpha) : 0.18;
...
function Pt(e, t) {
  ...
  if (i.startsWith("#")) {
    const s = qt(i);
    return s ? `rgba(${s.r}, ${s.g}, ${s.b}, ${St(t)})` : i;
  }
  return i;
}
function _t(e) {
...
var F;
const v = (F = class extends W {
  constructor() {
    super(...arguments), S(this, Q), S(this, X), S(this, tt, []), S(this, et, !1), S(this, it, ""), S(this, st, null), S(this, rt, "idle"), S(this, nt, ""), this._jsonUrlLast = "", this._lastWatchSig = null, this._lastWeekOffset = null;
  }
  getGridOptions() {
    return { columns: "full" };
  }
  ...
  setConfig(e) {
    const t = F.getStubConfig(), i = ((e?.type ?? t.type) + "").toString();
  ...
  normalizeConfig(e) {
    const t = F.getStubConfig(), i = Array.isArray(e.days) && e.days.length ? e.days.map((c) => (c ?? "").toString()) : ["Mo", "Di", "Mi", "Do", "Fr"], s = (Array.isArray(e.rows) ? e.rows : []).map((c) => {
      if (lt(c))
        return { break: !0, time: (c.time ?? "").toString(), label: (c.label ?? "Pause").toString() };
      const d = Array.isArray(c?.cells) ? c.cells : [], g = Array.from({ length: i.length }, (b, y) => (d[y] ?? "").toString()), h = Array.isArray(c?.cell_styles) ? c.cell_styles : [], _ = Array.from({ length: i.length }, (b, y) => Ce(h[y])), w = (c?.time ?? "").toString(), P = _t(w), m = (c?.start ?? "").toString().trim(), f = (c?.end ?? "").toString().trim(), M = {
        time: w,
        start: m || P.start || void 0,
        end: f || P.end || void 0,
        cells: g
      };
      return _.some((b) => !!b) && (M.cell_styles = _), M;
    }), r = ((e.week_mode ?? t.week_mode) + "").toString().trim(), n = r === "kw_parity" || r === "week_map" || r === "off" ? r : "off", o = (e.source_entity ?? t.source_entity).toString().trim(), l = (e.week_offset_entity ?? "").toString().trim() || De(o), a = (() => {
      const c = ((e.source_type ?? "") + "").toString().trim();
      if (c === "manual" || c === "entity" || c === "json" || c === "legacy") return c;
      if (o) {
        const d = ((e.source_attribute ?? "") + "").toString().trim(), g = ((e.source_time_key ?? "") + "").toString().trim();
        return !(/_woche$/i.test(o) && (d === "" || d === "rows_table") && (g === "" || g === "time")) && (d || g) ? "legacy" : "entity";
      }
      return "manual";
    })();
    return {
      ...
      source_entity: o,
      source_attribute: (a === "entity" ? "rows_table" : a === "legacy" ? ((e.source_attribute ?? "") + "").toString().trim() || "plan" : e.source_attribute ?? t.source_attribute).toString(),
      source_time_key: (a === "entity" ? "time" : a === "legacy" ? ((e.source_time_key ?? "") + "").toString().trim() || "Stunde" : e.source_time_key ?? t.source_time_key).toString(),
      source_type: a,
      json_url: (e.json_url ?? "").toString(),
      week_offset_entity: l,
  ...
  getTodayIndex(e) {
    const t = (/* @__PURE__ */ new Date()).getDay(), i = new Set(je(t).map(ft));
    if (!i.size) return -1;
    const s = (e ?? []).map((r) => ft(r));
  ...
  buildRowsFromArray(e, t) {
    ...
    const i = e.days ?? [], s = (e.source_time_key ?? "time").toString(), r = t.map((n) => {
      ...
      const o = (n?.time ?? n?.[s] ?? "").toString(), l = _t(o), a = Array.from({ length: i.length }, (g, h) => {
        const _ = (i[h] ?? "").toString();
        return (n?.[_] ?? "").toString();
      }), c = (n?.start ?? "").toString().trim() || l.start, d = (n?.end ?? "").toString().trim() || l.end;
      return { time: o, start: c || void 0, end: d || void 0, cells: a };
    });
  ...
  weekFromParity(e) {
    const { isoWeek: t } = Ht(/* @__PURE__ */ new Date()), i = t % 2 === 0, s = !!e.week_a_is_even_kw;
    return i === s ? "A" : "B";
  }
  weekFromMap(e) {
    ...
    const { isoWeek: r, isoYear: n } = Ht(/* @__PURE__ */ new Date()), o = String(r), l = String(n);
  ...
  getHeaderDaysFromEntity(e) {
    ...
    for (const n of s) {
      ...
      if (!o) continue;
      const l = Number(o[1]), a = Number(o[2]), c = Number(o[3]), d = new Date(l, a - 1, c, 12, 0, 0, 0);
...
`).map((h) => h.trim()).filter((h) => h.length > 0);
    ...
    if (!d) {
      const h = l.filter((_) => !n(_) && !o(_));
      d = h.length ? h[h.length - 1] : void 0;
    }
    const g = i.slice(1).filter((h) => n(h));
    return { fach: r, raum: c, lehrer: d, notes: g.length ? g : void 0 };
  }
  renderCell(e, t) {
      ...
      return u`
        <div class="cellWrap">
          ...
          ${r.notes?.length ? u`
                <div class="notes">
                  ${r.notes.map((a) => {
        const c = a.startsWith("🔴") ? "note noteRed" : a.startsWith("🟠") ? "note noteOrange" : a.startsWith("🟡") ? "note noteYellow" : "note", d = a.replace(/^[🟠🔴🟡🟢⚪️🟣🟤]\s*/g, "").trim();
        return u`<div class=${c}><span class="dot">${a.slice(0, 2).trim()}</span><span class="txt">${d}</span></div>`;
      })}
                </div>
              ` : u``}
        </div>
...
`).map((a) => a.trim()).filter(Boolean), o = (n[0] ?? "").trim(), l = n.slice(1);
    return o && l.length ? u`
        <div class="cellWrap">
          ...
          <div class="notes">
            ${l.map((a) => {
      const c = a.startsWith("🔴") ? "note noteRed" : a.startsWith("🟠") ? "note noteOrange" : a.startsWith("🟡") ? "note noteYellow" : "note", d = a.replace(/^[🟠🔴🟡🟢⚪️🟣🟤]\s*/g, "").trim(), g = /^[🟠🔴🟡🟢⚪️🟣🟤]/.test(a) ? a.slice(0, 2).trim() : "•";
      return u`<div class=${c}><span class="dot">${g}</span><span class="txt">${d || a}</span></div>`;
    })}
          </div>
        </div>
      ` : u`<span class="cellText">${s}</span>`;
  }
  render() {
    if (!this.config) return u``;
    const e = this.config, t = this._rowsCache, i = this.getTodayIndex(e.days ?? []), s = "1px solid var(--divider-color)", r = Pt(e.highlight_today_color ?? "", 0.12), n = Pt(e.highlight_current_color ?? "", 0.18), o = (e.highlight_current_text_color ?? "").toString().trim(), l = (e.highlight_current_time_text_color ?? "").toString().trim(), a = e.week_mode !== "off", c = a ? this.getActiveWeek(e) : null, d = this.getWeekOffsetValue(e), g = (e.week_offset_entity ?? "").trim().length > 0, h = this.getHeaderDaysFromEntity(e), _ = h && h.length >= (e.days?.length ?? 0) ? h : null, w = this.getBaseDate(e), P = this.mondayOfWeek(w);
    return u`
      <ha-card>
        <div class="headerRow">
          ...
          <div class="headRight">
            ${a ? u`<div class="weekBadgeInline">Woche <b>${c}</b></div>` : u``}

            ${g ? u`
                  <div class="offsetInline">
                    <button class="btnMini" @click=${() => d != null && this.setWeekOffset(e, d - 1)}>&lt;</button>
                    <div class="offsetVal">${d ?? "?"}</div>
                    <button class="btnMini" @click=${() => d != null && this.setWeekOffset(e, d + 1)}>&gt;</button>
                  </div>
                ` : u``}
          </div>
          ...
          <table>
            <thead>
              <tr>
                ...
                ${e.days.map((m, f) => {
      const M = e.highlight_today && f === i ? "today" : "";
      let b = "";
      if (_)
        b = this.fmtDDMMYYYY(_[f]);
      else {
        const y = Re(m);
        if (y) {
          const Z = new Date(P);
          Z.setDate(P.getDate() + (y - 1)), b = this.fmtDDMMYYYY(Z);
        }
      }
      return u`
                    <th class=${M} style=${`--sp-hl:${r};`}>
                      <div>${m}</div>
            ...
            <tbody>
              ${this._noData ? u`<tr class="nodata"><td class="nodataCell" colspan=${(e.days?.length ?? 0) + 1}>${this._noDataMsg}</td></tr>` : t.map((m) => {
      if (lt(m)) {
        const H = _t(m.time), R = !!H.start && !!H.end && this.isNowBetween(H.start, H.end), L = !!e.highlight_breaks && R;
        let z = `--sp-hl:${n};`, q = "";
        return L && (z += "box-shadow: inset 0 0 0 9999px var(--sp-hl);", q += `--sp-hl:${n}; box-shadow: inset 0 0 0 9999px var(--sp-hl);`), L && e.highlight_current_time_text && l && (z += `color:${l};`), u`
                    <tr class="break">
                      <td class="time" style=${z}>${m.time}</td>
                      <td colspan=${e.days.length} style=${q}>${m.label ?? ""}</td>
                    </tr>
                  `;
      }
      const f = m, M = f.cells ?? [], b = f.cell_styles ?? [], y = !!f.start && !!f.end && this.isNowBetween(f.start, f.end), Z = i >= 0 ? M[i] ?? "" : "", Xt = i >= 0 ? this.filterCellText(Z, e) : "", te = i >= 0 ? pt(Xt) : !1, ut = !(e.free_only_column_highlight && te), kt = f.start && f.end ? `${f.start}–${f.end}` : "";
      let dt = `--sp-hl:${n};`;
      return ut && e.highlight_current && y && (dt += "box-shadow: inset 0 0 0 9999px var(--sp-hl);"), ut && y && e.highlight_current_time_text && l && (dt += `color:${l};`), u`
                  <tr>
                    <td class="time" style=${dt}>
                      <div class="timeWrap">
                        <div class="timeSt">${f.time}</div>
                        ${kt ? u`<div class="timeHm">${kt}</div>` : u``}
                      </div>
                    </td>

                    ${e.days.map((H, R) => {
        const L = this.filterCellText(M[R] ?? "", e), z = b[R] ?? null, q = e.highlight_today && R === i ? "today" : "";
        let At = `--sp-hl:${r};` + Te(z, s);
        const ee = !pt(L);
        return ut && ee && y && e.highlight_current_text && o && i >= 0 && R === i && (At += `color:${o};`), u`<td class=${q} style=${At}>${this.renderCell(L, e)}</td>`;
      })}
                  </tr>
                `;
    })}
...
const mt = class extends W {
  ...
  normalizeConfig(t) {
    return new Gt().normalizeConfig(t);
  }
  clone(t) {
    try {
  ...
  emit(t) {
    this._config = t, Oe(this, "config-changed", { config: t });
  }
  setValue(t, i) {
  ...
  setSourceType(t) {
    ...
    if (i === "json" && s.json_url == null && (s.json_url = ""), i === "entity") {
      const r = (s.integration_entity ?? "").toString().trim() || (s.source_entity ?? "").toString().trim();
      s.integration_entity = r, s.source_entity = r, s.source_attribute = "rows_table", s.source_time_key = "time";
    }
    if (i === "legacy") {
      const r = (s.legacy_entity ?? "").toString().trim() || (s.source_entity ?? "").toString().trim();
      s.legacy_entity = r, s.source_entity = r;
      const n = (s.source_attribute ?? "").toString().trim(), o = (s.source_time_key ?? "").toString().trim(), l = (s.legacy_attribute ?? "").toString().trim() || (n && n !== "rows_table" ? n : ""), a = (s.legacy_time_key ?? "").toString().trim() || (o && o !== "time" ? o : "");
      s.legacy_attribute = l || "plan", s.legacy_time_key = a || "Stunde", s.source_attribute = s.legacy_attribute, s.source_time_key = s.legacy_time_key;
    }
    this.emit(s);
  }
  setSourceEntity(t) {
    if (!this._config) return;
    const i = (t ?? "").toString().trim(), s = (this._config.source_type ?? "entity").toString();
    if (s === "legacy") {
      this.emit({
        ...this._config,
        source_type: "legacy",
    ...
    this.emit({ ...this._config, source_entity: i });
  }
  setJsonUrl(t) {
  ...
  renderSection(t, i, s) {
    ...
    return u`
      <div class="section">
        ...
        ${r ? u`<div class="sectionBody">${s}</div>` : u``}
      </div>
    `;
  }
  onToggle(t, i) {
      ...
      u`
            <div class="grid2">
              ...
              <ha-textfield
                label="Tage (CSV)"
                .value=${Ue(t.days ?? [])}
                @input=${(i) => this.setValue("days", We(i.target.value))}
      ...
      u`
        ...
        try {
          ...
          console.error("stundenplan-card editor: ha-form value-changed failed", s);
            ...
            ${["entity", "legacy"].includes(t.source_type ?? "manual") ? u`
        ...
        return i === "entity" && (n < 20 || n > 0 && r.length === 0) ? u`<div class="hint">Lade Stundenplan-Sensoren…</div>` : u``;
      })()}
                        <ha-entity-picker
                          .hass=${this.hass}
                          .value=${(() => {
        const i = t.source_type ?? "manual", s = (t.source_entity ?? "").toString();
        return i === "legacy" ? (t.legacy_entity ?? "").toString().trim() || (s && !/_woche$/i.test(s) ? s : "") : i === "entity" ? (t.integration_entity ?? "").toString().trim() || (s && /_woche$/i.test(s) ? s : "") : s;
      })()}
                          .includeDomains=${["sensor"]}
                          .entityFilter=${(i) => {
        const s = (i ?? "").toString();
        return (t.source_type ?? "manual") === "entity" ? /_woche$/i.test(s) : /^sensor\./.test(s);
      }}
                          .label=${(t.source_type ?? "manual") === "entity" ? "Stundenplan24 Sensor" : "REST-Sensor (Legacy)"}
                          @value-changed=${(i) => {
        try {
          this.setSourceEntity(i.detail?.value ?? i.target?.value);
        } catch (s) {
        ...
        return i === "legacy" ? (t.legacy_entity ?? "").toString().trim() || (s && !/_woche$/i.test(s) ? s : "") : i === "entity" ? (t.integration_entity ?? "").toString().trim() || (s && /_woche$/i.test(s) ? s : "") : s;
                      ...
                      ${(t.source_type ?? "manual") === "legacy" ? u`
                        <div class="grid2">
                          <ha-textfield label="Attribut" .value=${(() => {
        const i = (t.legacy_attribute ?? "").toString().trim();
        if (i) return i;
        const s = (t.source_attribute ?? "").toString().trim();
        return s && s !== "rows_table" ? s : "";
      })()} @input=${(i) => {
        this.onText(i, "legacy_attribute"), this.onText(i, "source_attribute");
      }} placeholder="plan"></ha-textfield>
                          <ha-textfield label="Time-Key" .value=${(() => {
        const i = (t.legacy_time_key ?? "").toString().trim();
        if (i) return i;
        const s = (t.source_time_key ?? "").toString().trim();
        return s && s !== "time" ? s : "";
      })()} @input=${(i) => {
        this.onText(i, "legacy_time_key"), this.onText(i, "source_time_key");
      }} placeholder="Stunde"></ha-textfield>
                        </div>
                        <div class="hint">Legacy: REST-Sensor + JSON-Attribut (z.B. <code>plan</code>) und Zeit-Key (z.B. <code>Stunde</code>).</div>
                      ` : u``}
                ` : u``}

            ${(t.source_type ?? "manual") === "json" ? u`
                  <div class="hint">
        ...
        try {
          ...
          typeof n == "boolean" && n !== A(t.week_a_is_even_kw, !0) && this.setValue("week_a_is_even_kw", n);
        } catch (s) {
          console.error("stundenplan-card editor: week settings change failed", s);
        }
      }}
                          ></ha-form>
                        </div>${t.week_mode === "week_map" ? u`
                              <div class="grid2">
                                <ha-textfield
