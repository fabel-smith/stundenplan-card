...
const ie = (r) => new Ft(typeof r == "string" ? r : r + "", void 0, vt), It = (r, ...t) => {
  const e = r.length === 1 ? r[0] : t.reduce((s, i, n) => s + ((o) => {
    if (o._$cssResult$ === !0) return o.cssText;
    if (typeof o == "number") return o;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + o + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(i) + r[n + 1], r[0]);
  return new Ft(e, r, vt);
}, re = (r, t) => {
...
const { is: ne, defineProperty: oe, getOwnPropertyDescriptor: ae, getOwnPropertyNames: le, getOwnPropertySymbols: ce, getPrototypeOf: he } = Object, dt = globalThis, Tt = dt.trustedTypes, ue = Tt ? Tt.emptyScript : "", de = dt.reactiveElementPolyfillSupport, V = (r, t) => r, at = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? ue : null;
      break;
...
const xt = globalThis, jt = (r) => r, lt = xt.trustedTypes, Ot = lt ? lt.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, Jt = "$lit$", C = `lit$${Math.random().toFixed(9).slice(2)}$`, Vt = "?" + C, _e = `<${Vt}>`, j = document, Y = () => j.createComment(""), K = (r) => r === null || typeof r != "object" && typeof r != "function", kt = Array.isArray, pe = (r) => kt(r) || typeof r?.[Symbol.iterator] == "function", ft = `[ 	
\f\r]`, J = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Wt = /-->/g, Pt = />/g, T = RegExp(`>|${ft}(?:([^\\s"'>=/]+)(${ft}*=${ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Nt = /'/g, Ut = /"/g, Yt = /^(?:script|style|textarea|title)$/i, ge = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), d = ge(1), H = /* @__PURE__ */ Symbol.for("lit-noChange"), f = /* @__PURE__ */ Symbol.for("lit-nothing"), Ht = /* @__PURE__ */ new WeakMap(), R = j.createTreeWalker(j, 129);
function Kt(r, t) {
...
const fe = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const a = r[l];
    let c, _, h = -1, p = 0;
    for (; p < a.length && (o.lastIndex = p, _ = o.exec(a), _ !== null); ) p = o.lastIndex, o === J ? _[1] === "!--" ? o = Wt : _[1] !== void 0 ? o = Pt : _[2] !== void 0 ? (Yt.test(_[2]) && (i = RegExp("</" + _[2], "g")), o = T) : _[3] !== void 0 && (o = T) : o === T ? _[0] === ">" ? (o = i ?? J, h = -1) : _[1] === void 0 ? h = -2 : (h = o.lastIndex - _[2].length, c = _[1], o = _[3] === void 0 ? T : _[3] === '"' ? Ut : Nt) : o === Ut || o === Nt ? o = T : o === Wt || o === Pt ? o = J : (o = T, i = void 0);
    const u = o === T && r[l + 1].startsWith("/>") ? " " : "";
    n += o === J ? a + _e : h >= 0 ? (s.push(c), a.slice(0, h) + Jt + a.slice(h) + C + u) : a + C + (h === -2 ? l : u);
  }
...
class Z {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const l = t.length - 1, a = this.parts, [c, _] = fe(t, e);
    ...
    for (; (i = R.nextNode()) !== null && a.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const h of i.getAttributeNames()) if (h.endsWith(Jt)) {
          const p = _[o++], u = i.getAttribute(h).split(C), g = /([.?@])?(.*)/.exec(p);
          a.push({ type: 1, index: n, name: g[2], strings: u, ctor: g[1] === "." ? ye : g[1] === "?" ? we : g[1] === "@" ? $e : _t }), i.removeAttribute(h);
        } else h.startsWith(C) && (a.push({ type: 6, index: n }), i.removeAttribute(h));
        if (Yt.test(i.tagName)) {
          const h = i.textContent.split(C), p = h.length - 1;
          if (p > 0) {
            i.textContent = lt ? lt.emptyScript : "";
            for (let u = 0; u < p; u++) i.append(h[u], Y()), R.nextNode(), a.push({ type: 2, index: ++n });
            i.append(h[p], Y());
          }
        }
        ...
        let h = -1;
        for (; (h = i.data.indexOf(C, h + 1)) !== -1; ) a.push({ type: 7, index: n }), h += C.length - 1;
      }
      n++;
    }
  }
...
class me {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (o === a.index) {
        let c;
        a.type === 2 ? c = new q(n, n.nextSibling, this, t) : a.type === 1 ? c = new a.ctor(n, a.name, a.strings, this, t) : a.type === 6 && (c = new ve(n, this, t)), this._$AV.push(c), a = s[++l];
      }
...
class _t {
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (n === void 0) t = L(this, t, e, 0), o = !K(t) || t !== this._$AH && t !== H, o && (this._$AH = t);
      ...
      const l = t;
      let a, c;
      for (t = n[0], a = 0; a < n.length - 1; a++) c = L(this, l[s + a], e, a), c === H && (c = this._$AH[a]), o ||= !K(c) || c !== this._$AH[a], c === f ? t = f : t !== f && (t += (c ?? "") + n[a + 1]), this._$AH[a] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
U._$litElement$ = !0, U.finalized = !0, St.litElementHydrateSupport?.({ LitElement: U });
const ke = St.litElementPolyfillSupport;
ke?.({ LitElement: U });
(St.litElementVersions ??= []).push("4.2.2");
const Se = { attribute: !0, type: String, converter: at, reflect: !1, hasChanged: bt }, Ae = (r = Se, t, e) => {
...
}, Gt = (r, t, e) => t.has(r) || qt("Cannot " + e), k = (r, t, e) => (Gt(r, t, "read from private field"), e ? e.call(r) : t.get(r)), S = (r, t, e) => t.has(r) ? qt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(r) : t.set(r, e), A = (r, t, e, s) => (Gt(r, t, "write to private field"), t.set(r, e), e), X, tt, et, st, it, rt, nt, ot;
function ct(r) {
  return !!r && r.break === !0;
}
function At(r) {
...
const v = (D = class extends U {
  constructor() {
    super(...arguments), S(this, X), S(this, tt), S(this, et, []), S(this, st, !1), S(this, it, ""), S(this, rt, null), S(this, nt, "idle"), S(this, ot, ""), this._jsonUrlLast = "", this._lastWatchSig = null, this._lastWeekOffset = null, this._uiViewMode = null, this._uiPopupOpen = !1;
  }
  getGridOptions() {
    return { columns: "full" };
  }
  ...
  getEntitySig(t) {
    ...
    const s = e.last_updated ?? "", i = e.last_changed ?? "", n = e.state ?? "", o = e.attributes ?? {}, l = o.plan ?? o.rows ?? o.rows_table ?? o.rows_json ?? o.rows_ha, a = Array.isArray(l) || typeof l == "string" ? l.length : 0;
  ...
  setConfig(t) {
    const e = D.getStubConfig(), s = ((t?.type ?? e.type) + "").toString();
  ...
  normalizeTapAction(t) {
    const e = typeof t == "object" && t ? t : {};
    const s = ((e.action ?? "none") + "").toString().trim();
    const i = s === "toggle_view" || s === "popup_week" || s === "navigate" || s === "url" || s === "more-info" ? s : "none";
    return {
      action: i,
  ...
  getTitleStyle(t) {
    const e = [];
    const s = Number(t.title_font_size);
    Number.isFinite(s) && s > 0 && e.push(`font-size:${Math.max(10, Math.min(40, s))}px`);
  ...
  findConfiguredDayIndexForDate(t, e) {
    const s = t.getDay() === 0 ? 7 : t.getDay();
    return (e ?? []).findIndex((i) => Oe(i) === s);
  }
  ...
  nextConfiguredSchoolday(t, e) {
    ...
    for (let i = 0; i < 14; i++) {
      ...
      if (this.isConfiguredSchoolday(s, e)) return s;
    }
    return s;
  }
  getLastLessonEnd() {
  ...
  shouldAdvanceRollingDay(t, e) {
    ...
    if (s === "fixed_time") {
      const i = ((t.rolling_switch_time ?? "") + "").toString().trim();
      const [n, o] = i.split(":").map(Number);
      return Number.isFinite(n) && Number.isFinite(o) ? (e.getHours() > n || e.getHours() === n && e.getMinutes() >= o) : !1;
    }
    return !1;
  ...
  getRollingVisibleSlots(t, e) {
    ...
    } else if (this.shouldAdvanceRollingDay(t, i)) {
      n = this.nextConfiguredSchoolday(n, s);
    }
    const o = [];
  ...
  async handleCardAction(t, e) {
    ...
    if (!i || i.action === "none") return;
    if (i.action === "toggle_view") {
      const l = ((this._uiViewMode ?? t.view_mode ?? "week") + "").toString();
      this._uiViewMode = l === "rolling" ? "week" : "rolling";
      this.requestUpdate();
      return;
    }
    if (i.action === "popup_week") {
      this._uiPopupOpen = !0;
      this.requestUpdate();
      return;
    }
    if (i.action === "navigate") {
      const l = (i.navigation_path ?? "").toString().trim();
      if (!l) return;
      history.pushState(null, "", l);
      We(window, "location-changed", { replace: !1 });
      return;
    }
    if (i.action === "url") {
      const l = (i.url_path ?? "").toString().trim();
      if (!l) return;
      window.open(l, i.target || "_blank");
      return;
    }
    if (i.action === "more-info") {
      const l = (i.entity ?? t.source_entity ?? t.source_entity_integration ?? "").toString().trim();
      if (!l) return;
      We(this, "hass-more-info", { entityId: l });
    }
  }
  closeWeekPopup(e) {
    e?.stopPropagation?.();
  ...
  getHeaderDaysFromEntity(t) {
    ...
    for (const l of n) {
      ...
      if (!c) continue;
      const _ = Number(c[1]), h = Number(c[2]), p = Number(c[3]), u = new Date(_, h - 1, p, 12, 0, 0, 0);
  ...
  getHeaderUpdatedFromEntity(t) {
    const sourceType = ((t.source_type ?? "manual") + "").toString().trim();
  ...
  renderCardLayout(t, vmOverride = null, popup = !1) {
    const e = this._rowsCache, u = this.getHeaderDaysFromEntity(t), s = this.getTodayIndex(t.days ?? [], u), vm = ((vmOverride ?? this._uiViewMode ?? t.view_mode ?? "week") + "").toString(), da = Number(t.days_ahead), daysAhead = Number.isFinite(da) ? Math.max(0, Math.min(6, Math.floor(da))) : 0, i = "1px solid var(--divider-color)", n = Lt(t.highlight_today_color ?? "", 0.12), o = Lt(t.highlight_current_color ?? "", 0.18), l = (t.highlight_current_text_color ?? "").toString().trim(), a = (t.highlight_current_time_text_color ?? "").toString().trim(), c = t.week_mode !== "off", _ = c ? this.getActiveWeek(t) : null, h = this.getWeekOffsetValue(t), sourceType = (t.source_type ?? "manual").toString(),
        ...
        updMap = (() => {
          ...
          g.forEach((m, W) => {
            const b = upd[W];
            if (m instanceof Date && b) y.set(this.fmtYMD(m), b);
          });
          return y;
        })();
    return d`
          ...
          <div class="headRight">
            ...
            ${showPager ? d`
                  <div class="offsetInline">
                    <button class="btnMini" @click=${(y) => { y.stopPropagation(), h != null && this.setWeekOffset(t, h - 1); }}>&lt;</button>
      ...
      let b = "";
      if (rollingDates?.[m] instanceof Date)
        b = this.fmtDDMMYYYY(rollingDates[m]);
      else if (g)
...
<div class="generalDivider first">Grunddaten</div>
            ...
            <div class="grid2">
              ...
              <ha-form
                ...
                .computeLabel=${(e) => e?.name === "display_mode" ? "Ansichtsdichte" : e?.name}
                @value-changed=${(e) => {
                  try {
                    e?.stopPropagation?.();
                    const v = (e?.detail?.value ?? {}).display_mode ?? "default";
                    this.setValue("display_mode", v);
                  } catch (s) {
            ...
            <div class="grid2">
              <ha-form
                ...
                .computeLabel=${(e) => e?.name === "tap_action_action" ? "Tap-Aktion" : e?.name}
                @value-changed=${(e) => {
                  try {
                    e?.stopPropagation?.();
                    const v = (e?.detail?.value ?? {}).tap_action_action ?? "none";
                    this.setValue("tap_action", { ...(t.tap_action ?? {}), action: v });
                  } catch (s) {
              ...
              ${((t.tap_action?.action ?? "none") + "").toString() === "toggle_view" ? d`
                <div class="hint">Ein Tipp auf die Karte wechselt zwischen „Ganze Woche“ und „Ab heute (rolling)“.</div>
              ` : ((t.tap_action?.action ?? "none") + "").toString() === "popup_week" ? d`
              ...
              ` : d`<div class="hint">Für Wallpanels sind meist „Ansicht umschalten“ oder „Wochen-Popup“ die sinnvollsten Varianten.</div>`}
            </div>
          `
    )}
